...
function SecondStep(props) {
    ...
    const changeCharacter = (e) => {
        ...
        props.setFormData({
            ...props.formData,
            character_id:e.target.textContent
        })
            ...
            <form onSubmit={submitHandler} >
                <div className='select-field'>
                    <div className='select-inputs'>
                        ...
                        {props.formData.level ? props.formData.level: 'Level of knowladge'} {!props.formData.level && <span>*</span> } </label>
                        <input
                        ...
                        {activeChoice ?
                        <img className='arrow-up' src={VectorUp} alt='arrowUp' />
                ...
                <div className='select-character'>
                        ...
                        <label onMouseDown={handleActiveCharacter} className={errorLabel}> {props.formData.character_id ? props.formData.character_id : 'choose'}
                        {!props.formData.character_id && <span>*</span>} </label>
                        <input value={props.formData.character_id} className={errorInput}
                        onMouseDown={handleActiveCharacter} onBlur={characterBlur}
                        onChange={changeCharacter} type="text" />
                        ...
                        <div className={activeCharacter ? 'character-list active' : 'character-list'}>
                            <ul>
                                ...
                                {characters.map((character) => {
                                    return (
                                        <li className='participants' onMouseDown={changeCharacter} key={character.id} data-id={character.id} >{character.name} <img src={`https://chess-tournament-api.devtest.ge/${character.image}`} alt="characters" /> </li>
                                    )
                                })}
                            </ul>
                        </div>
